...
Usage:
    # Single generation
    python wan2_1_t2v_1_3B_singleGPU_generation.py --token "your_token" --endpoint "your_endpoint" --prompt "your prompt"
    
    # Batch generation (comma-separated)
    python wan2_1_t2v_1_3B_singleGPU_generation.py --token "your_token" --endpoint "your_endpoint" --batch-prompts "prompt1,prompt2,prompt3"
    
    # Batch generation (file-based) - handles prompts with commas
    python wan2_1_t2v_1_3B_singleGPU_generation.py --token "your_token" --endpoint "your_endpoint" --batch-prompts-file "prompts_example.txt"
    
    # OR from vfms root directory:
    python example/scripts/wan2.1_t2v_1.3B_singleGPU/wan2_1_t2v_1_3B_singleGPU_generation.py --token "your_token" --endpoint "your_endpoint" --prompt "your prompt"

    # Test connection only
    python example/scripts/wan2.1_t2v_1.3B_singleGPU/wan2_1_t2v_1_3B_singleGPU_generation.py --token "your_token" --endpoint "your_endpoint" --test-connection
